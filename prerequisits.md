...
The work folder is a working directory created by the pipeline for it to run correctly.
...
![Example pipeline info folder structure](images/example_pipeline_info_folder.png)
